...
1. **GitHub private security advisory (preferred).**
   [Report a vulnerability](https://github.com/quantus-network/qp-poseidon/security/advisories/new).
...
**In scope:** the Poseidon2 hash implementation in this repository — collisions, deviations from the specification, or incorrect constants.
